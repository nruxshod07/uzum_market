...
function headers_1() {
    ...
    containers.classList.add('contners')
    ...
    body_2.append(containers)
    containers.append(header_flex_cont)
...
function hot_hrefs() {
    ...
    electrician.href = "/pages/electrics/index.html"
    appliances.href = "/pages/technic/index.html"
    cloth.href = "/pages/audio/index.html"
    accessories.href = "/pages/tv/index.html"
    shoes.href = "/pages/pc/index.html"
    beauty.href = "/pages/kitchen/index.html"
    household_products.href = "/pages/home_products/index.html"
}
hot_hrefs()