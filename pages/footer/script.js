...
function one_var() {
    ...
    let about_us_container = document.createElement('div')
    let about_us_container_h1 = document.createElement('h1')
    let about_us_container_a_1 = document.createElement('a')
    let about_us_container_BR = document.createElement('br')
    let about_us_container_a_2 = document.createElement('a')
    ...
    about_us_container_h1.classList.add('h1')
    about_us_container_a_1.classList.add('a')
    about_us_container_a_2.classList.add('a')
    ...
    about_us_container_h1.innerHTML = "О нас"
    about_us_container_a_1.innerHTML = "Пункт выдачи"
    about_us_container_a_2.innerHTML = "Вакансии"
    ...
    about_us_container_a_1.href = "#"
    about_us_container_a_2.href = "#"
    ...
    about_us_container.append(about_us_container_h1, about_us_container_a_1, about_us_container_BR, about_us_container_a_2)
...
function two_var() {
    ...
    let about_us_container_two_V = document.createElement('div')
    let about_us_container_two_V_h1 = document.createElement('h1')
    let about_us_container_two_V_img = document.createElement('img')
    ...
    about_us_container_two_V_img.classList.add('img')
    ...
    about_us_container_two_V_h1.innerHTML = "О нас"
    ...
    two_variant.append(about_us_container_two_V, defoult_height, for_entrepreneurs_contner_two_V, defoult_height_two, down_hr, for_entrepreneurs_contner_two_V, defoult_height_three, up_hr, download_box, uzum_network_box_two_V, down_two_V)
    about_us_container_two_V.append(about_us_container_two_V_h1, about_us_container_two_V_img, clone_arrow_one)
    ...
    about_us_container_two_V_img.onclick = () => {

        defoult_height_two.style.display = 'block'
        about_us_container_two_V_img.style.display = 'none'
    ...
    clone_arrow_one.onclick = () => {
        ...
        about_us_container_two_V_img.style.display = 'block'
